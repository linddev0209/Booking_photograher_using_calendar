...
if($_GET['st']!="") { 
	$company_st = $_GET['st'];	
	$letter_menu = '<a href="companies.php?st='.$company_st.'">All</a>';
	if ($_SESSION['SESS_LEVEL']=="dealer") {
	...
	if($num_count!="0") { 
		$letter_menu .= '<a href="companies.php?st='.$company_st.'&letter=num">#</a>'; 
	} else { 
...
foreach($letter_sort as $letter) {
	if($_GET['st']!="") { 
		...
		if($letter_count!="0") { 
			$letter_menu .= '<a href="companies.php?st='.$company_st.'&letter='.$letter.'">'.$letter.'</a>'; 
		} else { 
...
<html>
	<head>
		...
		<title>Companies | Look2 Home Marketing</title>
		...
		<div id="right_column">
			...
			<div id="rc_content_container">
				<div class="section_full_ra">
					<a href="company_edit.php">Add New Company</a>
				</div>
				<div class="section_container">
					...
					<div class="section_result_row">
						<a href="companies.php?st=<?php echo $comp_states['state']; ?>">
					...
					<div class="section_header">
						<svg xmlns="http://www.w3.org/2000/svg" class="section_icon" viewBox="0 0 50 50"><path d="M8 2v4H4v42h11v-9h4v9h11V6h-4V2zm2 8h2v2h-2zm4 0h2v2h-2zm4 0h2v2h-2zm4 0h2v2h-2zm10 4v4h2v2h-2v2h2v2h-2v2h2v2h-2v2h2v2h-2v2h2v2h-2v2h2v2h-2v2h2v2h-2v4h14V14zm-22 1h2v4h-2zm4 0h2v4h-2zm4 0h2v4h-2zm4 0h2v4h-2zm14 3h2v2h-2zm4 0h2v2h-2zm-30 3h2v4h-2zm4 0h2v4h-2zm4 0h2v4h-2zm4 0h2v4h-2zm14 1h2v2h-2zm4 0h2v2h-2zm-4 4h2v2h-2zm4 0h2v2h-2zm-30 1h2v4h-2zm4 0h2v4h-2zm4 0h2v4h-2zm4 0h2v4h-2zm14 3h2v2h-2zm4 0h2v2h-2zm-30 3h2v4h-2zm4 0h2v4h-2zm4 0h2v4h-2zm4 0h2v4h-2zm14 1h2v2h-2zm4 0h2v2h-2zm-4 4h2v2h-2zm4 0h2v2h-2zm-30 1h2v5h-2zm12 0h2v5h-2zm14 3h2v2h-2zm4 0h2v2h-2z"/></svg><h1>Companies - Select Company</h1>
					</div>
					...
					?>
					<div class="section_result_row">
						<a href="company_edit.php?company=<?php echo $select_comp['id']; ?>">
							...
							<div class="section_city">
								<?php echo $select_comp['office_phone']; ?>
							</div>
						</a>
						<div class="section_edit">
							<a class="remove_rec" href="companies.php?company=<?php echo $select_comp['id']; ?>&task=remcomp" onClick="confirmCleanUp('company - <?php echo $select_comp["name"]; ?>'); return returnvalue"><svg xmlns="http://www.w3.org/2000/svg" class="section_icon" viewBox="0 0 800 800"><path d="M800 400c0 220.9-179.1 400-400 400S0 620.9 0 400 179.1 0 400 0s400 179.1 400 400zm-560-40c-22.1 0-40 17.9-40 40s17.9 40 40 40h320c22.1 0 40-17.9 40-40s-17.9-40-40-40H240z" fill-rule="evenodd"/></svg>Remove</a>
						</div>
						<div class="clear"></div>
					</div>
					<?php } } ?>
