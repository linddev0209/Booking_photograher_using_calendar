...
<html>
	<head>
		...
		<title>File Downloads | Look2 Home Marketing</title>
		...
		<div class="section_container">
			...
			<div class="section_result_row">
				...
				<?php if($orders['status']=="complete") { ?>
					...
					<div class="clear"></div>
					<div class="section_full">
						<a class="anchor_enclose_white" href="zipfiles.php?order_id=<?php echo $order_id; ?>"><div class="menu_button_sm_in">Floor Plan(s)/Photos</div></a> - *This is all files for the order including <strong>high resolution photos</strong>*
					</div>
					<div class="section_full">
						<a href="lr_zip.php?order_id=<?php echo $order_id; ?>"><div class="menu_button_sm_in">Low Res Photos</div></a> - *This is for <strong>lower resolution photos</strong> only* <em>Slower as this option will be resizing the photos and will take a minute to start the download</em>
					</div>
					<?php if($orders['company_id']=="467") { ?>
						<div class="section_full">
							<a href="wr_zip.php?order_id=<?php echo $order_id; ?>">Web Ready Photos</a> - *This is for <strong>1401px x 788px photos</strong> only* <em>Slower as this option will be resizing the photos and will take a minute to start the download</em>
						</div>
					<?php } ?>
					<div class="section_full">For questions or support please contact us at <strong>(803) 847-0006</strong></div>
				<?php } ?>
			</div>
		</div>
		<div id="rc_footer">
