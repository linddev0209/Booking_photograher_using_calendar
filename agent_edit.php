...
if ($c_id!="") {
	...
	$company_assign = mysqli_fetch_array($company_info);
} 

if ($a_id!="") {
	if(!($agent_info = mysqli_query($link,"SELECT * FROM users where id = '$a_id'"))){
		printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
		exit();
	}
	$agent_profile = mysqli_fetch_array($agent_info);
	$c4 = $agent_profile['c4'];
	if(!($rate_info = mysqli_query($link,"SELECT * FROM agent_rates where agent_id = '$a_id'"))){
		printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
		exit();
	}
	$agent_rate = mysqli_fetch_array($rate_info);
	$company_id = $agent_profile['company_id'];
}

if($_POST['Submitagent']){
	$a_id = $_POST['agent'];
	if($a_id!="") {
		...
		$age = mysqli_fetch_array($agent_db);
	}
	if($_POST['pass']!="") {
		$passencrypt = SHA1($_POST['pass']);
	} else {
		$passencrypt = $age['pass'];
	}
	...
	$assist_email = $_POST['assist_email']; 
	$assist_name = filter_var($_POST['assist_name'], FILTER_SANITIZE_STRING); 
	$assist_phone = $_POST['assist_phone']; 
	$assist_notify = $_POST['assist_notify'];
	$assist_notify_bill = $_POST['assist_notify_bill'];
	
	$assist_email2 = $_POST['assist_email2'];
	$assist_name2 = filter_var($_POST['assist_name2'], FILTER_SANITIZE_STRING); 
	$assist_phone2 = $_POST['assist_phone2']; 
	$assist_notify2 = $_POST['assist_notify2']; 
	...
	if($a_id!="") {
		if(!($agent_update = mysqli_query($link,"UPDATE users SET email='$email',pass='$passencrypt',firstname='$firstname',lastname='$lastname',site='$site',address='$address',city='$city',state='$state',zip='$zip',office_phone='$officephone',extension='$extension',cell_phone='$cellphone',assist_email='$assist_email',assist_name='$assist_name',assist_notify='$assist_notify',assist_notify_bill='$assist_notify_bill',level='$level',company_id='$comp_id',designed='$designed',active='$active' WHERE id = '$a_id'"))){
			printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
			exit();
		}
		if(!($rate_count = mysqli_query($link,"SELECT * FROM agent_rates WHERE agent_id = '$a_id'"))){
			printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
			exit();
		}
		if(mysqli_num_rows($rate_count)==""){
			if(!($rate_record = mysqli_query($link,"INSERT INTO agent_rates SET agent_id = '$a_id', r1_name = '$r1_name', r1_price = '$r1_price', r2_name = '$r2_name', r2_price = '$r2_price', r3_name = '$r3_name', r3_price = '$r3_price', r4_name = '$r4_name', r4_price = '$r4_price', r5_name = '$r5_name', r5_price = '$r5_price', tv1_name = '$tv1_name', tv1_price = '$tv1_price', tv2_name = '$tv2_name', tv2_price = '$tv2_price', tv3_name = '$tv3_name', tv3_price = '$tv3_price', tv4_name = '$tv4_name', tv4_price = '$tv4_price', tv5_name = '$tv5_name', tv5_price = '$tv5_price', rebuild = '$rebuild', reshoot = '$reshoot', drawing = '$draw', tlight = '$tlight', aphotos = '$aphotos', avid = '$avid', 3d = '$zd', atc = '$atc'"))){
				printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
				exit();
			}
		} else {
			if(!($rate_record = mysqli_query($link,"UPDATE agent_rates SET r1_name = '$r1_name', r1_price = '$r1_price', r2_name = '$r2_name', r2_price = '$r2_price', r3_name = '$r3_name', r3_price = '$r3_price', r4_name = '$r4_name', r4_price = '$r4_price', r5_name = '$r5_name', r5_price = '$r5_price', tv1_name = '$tv1_name', tv1_price = '$tv1_price', tv2_name = '$tv2_name', tv2_price = '$tv2_price', tv3_name = '$tv3_name', tv3_price = '$tv3_price', tv4_name = '$tv4_name', tv4_price = '$tv4_price', tv5_name = '$tv5_name', tv5_price = '$tv5_price', rebuild = '$rebuild', reshoot = '$reshoot', drawing = '$draw', tlight = '$tlight', aphotos = '$aphotos', avid = '$avid', 3d = '$zd', atc = '$atc' WHERE agent_id = '$a_id'"))){
				printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
				exit();
			}
		}
	} else {
		if(!($agent_update = mysqli_query($link,"INSERT INTO users SET email='$email',pass='$passencrypt',firstname='$firstname',lastname='$lastname',site='$site',address='$address',city='$city',state='$state',zip='$zip',office_phone='$officephone',extension='$extension',cell_phone='$cellphone',assist_email='$assist_email',assist_name='$assist_name',assist_notify='$assist_notify',assist_notify_bill='$assist_notify_bill',level='$level',company_id='$comp_id',designed='$designed',active='$active'"))){
		printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
		exit();
	}
	$new_a_id = mysqli_insert_id($link);
		if(!($rate_record = mysqli_query($link,"INSERT INTO agent_rates SET agent_id = '$new_a_id', r1_name = '$r1_name', r1_price = '$r1_price', r2_name = '$r2_name', r2_price = '$r2_price', r3_name = '$r3_name', r3_price = '$r3_price', r4_name = '$r4_name', r4_price = '$r4_price', r5_name = '$r5_name', r5_price = '$r5_price', tv1_name = '$tv1_name', tv1_price = '$tv1_price', tv2_name = '$tv2_name', tv2_price = '$tv2_price', tv3_name = '$tv3_name', tv3_price = '$tv3_price', tv4_name = '$tv4_name', tv4_price = '$tv4_price', tv5_name = '$tv5_name', tv5_price = '$tv5_price', rebuild = '$rebuild', reshoot = '$reshoot', drawing = '$draw', tlight = '$tlight', aphotos = '$aphotos', avid = '$avid', 3d = '$zd', atc = '$atc'"))){
				printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
				exit();
		}	
	...
	if($_FILES['uphoto']['name'] != NULL){ 
		$file_name = $_FILES['uphoto']['name'];
      	...
      	if(in_array($file_ext,$expensions)=== false){
          	header("Location: agent_edit.php?agent=".$photo_id."&flag=notvalid");
		  	exit;
      	}
	...
	if($a_id!="") {
		$flag = "updated";
		header("Location: agent_edit.php?agent=".$a_id."&flag=".$flag."");
		exit();	
	 } else {
		$flag = "created";
		header("Location: agent_edit.php?agent=".$new_a_id."&flag=".$flag."");
		exit();
	}
}
?>
			...
			<div id="rc_content_container">
				<?php if($a_id!="") { ?>
					<div class="section_full_ra">
						<a href="enter_order1.php?a_id=<?php echo $a_id; ?>">Enter Order for this agent</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="order_history.php?agent=<?php echo $a_id; ?>">View Orders for this agent</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="history_billing.php?agent=<?php echo $a_id; ?>">View Billing History for this agent</a>
					</div>
				<?php } ?>
				<form action="agent_edit.php" method="post" name="cedit" id="cedit" enctype="multipart/form-data">
					<div class="section_container">
						<div class="section_header">
							<svg xmlns="http://www.w3.org/2000/svg" class="section_icon" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 364 364"><defs><path id="A" d="M0 0h364v364H0z"/></defs><clipPath id="B"><use xlink:href="#A"/></clipPath><path d="M278.8 194.8l-92.5 92.5-92.5-92.5c-27 12.7-49.8 42.1-49.8 69.8v200.8c0 11.4 5.8 21.4 14.6 27.4l-20.7 97.5-64.9-13.9c-5.4-1.2-10.7 2.3-11.9 7.7v.1L-76.3 760c-1.2 5.4 2.3 10.7 7.7 11.9l32.3 6.9c.1-2 .2-4 .7-6.1 4.8-22.4 26.8-36.8 49.3-32 6.5 1.4 12.2 4.4 17.1 8.2l30.6-143.6 22.8-107.1h15.9l12.6 268.4c0 19.4 15.7 35.2 35.2 35.2h38.4 38.4c19.4 0 35.2-15.8 35.2-35.2l12.6-268.4h23.1c18.3 0 33-14.8 33-33V264.6c-.1-27.7-22.9-57.1-49.8-69.8h0zM187 152.7c41.6 0 75.3-33.7 75.3-75.3C262.4 35.7 228.7 2 187 2c-41.6 0-75.3 33.7-75.3 75.3s33.7 75.4 75.3 75.4zm-21 31.7v59.2l20.3 27.1 20.3-27.1v-59.2h-20.3H166zM9.3 761.3c-11.1-2.4-22 4.7-24.4 15.8s4.7 22 15.9 24.4c11.1 2.4 22-4.7 24.4-15.8 2.3-11.1-4.8-22-15.9-24.4z" clip-path="url(#B)"/></svg><h1>Manage Agent</h1>
						</div>
						...
						<div class="section_result_row">
							...
							<div class="section_form_36">
								<input name="fname" type="text" id="fname" value="<?php echo $agent_profile['firstname']; ?>" size="32" />
							</div>
							<div class="section_form_14">
								Address:
							</div>
							<div class="section_form_36">
								<input name="address" type="text" id="address" value="<?php echo $agent_profile['address']; ?>" size="32" />
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
								Last Name:
							...
							<div class="section_form_36">
								<input name="lname" type="text" id="lname" value="<?php echo $agent_profile['lastname']; ?>" size="32" />
							</div>
							<div class="section_form_14">
								City:
							</div>
							<div class="section_form_36">
								<input name="city" type="text" id="city" value="<?php echo $agent_profile['city']; ?>" size="32" />
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
								&nbsp;
							...
							<div class="section_form_14">
								<input name="state" type="text" id="state" value="<?php echo $agent_profile['state']; ?>" size="4" maxlength="2" />
							</div>
							<div class="section_form_10">
								Zip:
							</div>
							<div class="section_form_14">
								<input name="zip" type="text" id="zip" value="<?php echo $agent_profile['zip']; ?>" size="10" maxlength="5" />
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
								Email Address:
							...
							<div class="section_form_36">
								<input name="email" type="text" id="email" value="<?php echo $agent_profile['email']; ?>" size="32" />
							</div>
							<div class="section_form_14">
								Web Site:
							</div>
							<div class="section_form_36">
								<input name="site" type="text" id="site" value="<?php echo $agent_profile['site']; ?>" size="32" />
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
								Cell Phone:
							...
							<div class="section_form_36">
								<input name="extension" type="text" id="extension" value="<?php echo $agent_profile['extension']; ?>" size="12" maxlength="12" />
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
							...
							<div class="section_form_36">
								<input name="assist_email" type="text" id="assist_email" value="<?php echo $agent_profile['assist_email']; ?>" size="32" />
							</div>
							<div class="section_form_14">
								Assistant Name:
							</div>
							<div class="section_form_36">
								<input name="assist_name" type="text" id="assist_name" value="<?php echo $agent_profile['assist_name']; ?>" size="32" />
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
								Assistant Receive Orders:
							</div>
							<div class="section_form_36">
								<select name="assist_notify" id="assist_notify">
                    				<option value="n" selected="selected">No</option>
                    				<option value="y" <?php if ($agent_profile['assist_notify']=="y") echo "selected"; ?>>Yes</option>
                  				</select>
							</div>
							<div class="section_form_14">
								Assistant Receive Receipts:
							</div>
							<div class="section_form_36">
								<select name="assist_notify_bill" id="assist_notify_bill">
                    				<option value="n" selected="selected">No</option>
                    				<option value="y" <?php if ($agent_profile['assist_notify_bill']=="y") echo "selected"; ?>>Yes</option>
                  				</select>
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
							...
							<div class="section_form_36">
								<span class="agent_pic_order_80">
									<?php if(file_exists("floorplan/profile/".$a_id.".jpg")){ ?><img src="floorplan/profile/<?php echo $a_id; ?>.jpg" width="80px" alt="<?php echo $agent_profile['firstname']." ". $agent_profile['lastname']; ?>"><?php } ?>
								</span>
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
							...
							<div class="section_form_50">
								<?php if ($c_id!="") { echo $company_assign['name'].' <input type="hidden" name="comp_id" id="comp_id" value="'.$c_id.'" />'; } else { 
									if($_SESSION['SESS_LEVEL']=="dealer") {
										if(!($comp_db = mysqli_query($link,"SELECT * FROM companies WHERE location = '$dealer_id' ORDER BY name ASC"))){
											printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
											exit();
									} } else { 
										if(!($comp_db = mysqli_query($link,"SELECT * FROM companies ORDER BY name ASC"))){
											printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
											exit();
									} } ?>
                  					<select name="comp_id" id="comp_id" >
                   					<?php while($sel_comp=mysqli_fetch_array($comp_db)){	?>
                						<option value="<?php echo $sel_comp['id']; ?>" <?php if ($sel_comp['id']==$company_id) echo "selected"; ?>><?php echo $sel_comp['name']; ?></option> 
               					 	<?php } ?>
                 					</select>
								<?php } ?>
							</div>
							<div class="section_form_14">
								<?php if($_SESSION['SESS_LEVEL']=="admin" || $_SESSION['SESS_LEVEL']=="staff") { ?>Custom Design<?php } else { echo "&nbsp;"; } ?>
							</div>
							<div class="section_form_14">
								<?php if($_SESSION['SESS_LEVEL']=="admin" || $_SESSION['SESS_LEVEL']=="staff") { ?>
									<select name="designed" id="designed">
                    					<option value="n" selected="selected">No</option>
                    					<option value="y">Yes</option>
                  					</select>
								<?php } else { ?>
									<input name="designed" type="hidden" value="<?php echo $agent_profile['designed']; ?>" />
								<?php } ?>
							</div>
							<div class="clear"></div>
							...
							<div class="section_form_36">
								<select name="active" id="active">
                    				...
                    				<option value="n" <?php if($agent_profile['active']=='n') echo "selected" ?>>No</option>
                  				</select>
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
							...
							<?php if ($_SESSION['SESS_LEVEL']=="admin") { ?>
								<div class="section_form_14">
									<a class="cc" href="agent_cc.php?agent=<?php echo $a_id; ?>">Update Credit Card</a>
								</div>
							<?php } ?>
							<div class="clear"></div>
						</div>
					...
					<div class="section_container">
						...
						<div class="section_result_row">
							...
							<div class="clear"></div>
							<div class="section_form_20">Title:&nbsp;<input name="r1name" type="text" id="r1name" value="<?php echo $agent_rate['r1_name']; ?>" size="16" /></div>
							<div class="section_form_20">Title:&nbsp;<input name="r2name" type="text" id="r2name" value="<?php echo $agent_rate['r2_name']; ?>" size="16" /></div>
							<div class="section_form_20">Title:&nbsp;<input name="r3name" type="text" id="r3name" value="<?php echo $agent_rate['r3_name']; ?>" size="16" /></div>
							<div class="section_form_20">Title:&nbsp;<input name="r4name" type="text" id="r4name" value="<?php echo $agent_rate['r4_name']; ?>" size="16" /></div>
							<div class="section_form_20">Title:&nbsp;<input name="r5name" type="text" id="r5name" value="<?php echo $agent_rate['r5_name']; ?>" size="16" /></div>
							<div class="clear"></div>
							<div class="section_form_20">Rate:&nbsp;<input name="r1price" type="text" id="r1price" value="<?php echo $agent_rate['r1_price']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="r2price" type="text" id="r2price" value="<?php echo $agent_rate['r2_price']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="r3price" type="text" id="r3price" value="<?php echo $agent_rate['r3_price']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="r4price" type="text" id="r4price" value="<?php echo $agent_rate['r4_price']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="r5price" type="text" id="r5price" value="<?php echo $agent_rate['r5_price']; ?>" size="12" /></div>
							<div class="clear"></div>
							...
							<div class="clear"></div>
							<div class="section_form_20">Title:&nbsp;<input name="tv1name" type="text" id="tv1name" value="<?php echo $agent_rate['tv1_name']; ?>" size="16" /></div>
							<div class="section_form_20">Title:&nbsp;<input name="tv2name" type="text" id="tv2name" value="<?php echo $agent_rate['tv2_name']; ?>" size="16" /></div>
							<div class="section_form_20">Title:&nbsp;<input name="tv3name" type="text" id="tv3name" value="<?php echo $agent_rate['tv3_name']; ?>" size="16" /></div>
							<div class="section_form_20">Title:&nbsp;<input name="tv4name" type="text" id="tv4name" value="<?php echo $agent_rate['tv4_name']; ?>" size="16" /></div>
							<div class="section_form_20">Title:&nbsp;<input name="tv5name" type="text" id="tv5name" value="<?php echo $agent_rate['tv5_name']; ?>" size="16" /></div>
							<div class="clear"></div>
							<div class="section_form_20">Rate:&nbsp;<input name="tv1price" type="text" id="tv1price" value="<?php echo $agent_rate['tv1_price']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="tv2price" type="text" id="tv2price" value="<?php echo $agent_rate['tv2_price']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="tv3price" type="text" id="tv3price" value="<?php echo $agent_rate['tv3_price']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="tv4price" type="text" id="tv4price" value="<?php echo $agent_rate['tv4_price']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="tv5price" type="text" id="tv5price" value="<?php echo $agent_rate['tv5_price']; ?>" size="12" /></div>
							<div class="clear"></div>
							<div class="section_form_20">&nbsp;</div>
							<div class="clear"></div>
							...
							<div class="clear"></div>
							<div class="section_form_20">Rate:&nbsp;<input name="rebuild" type="text" id="rebuild" value="<?php echo $agent_rate['rebuild']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="picretake" type="text" id="picretake" value="<?php echo $agent_rate['picretake']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="draw" type="text" id="draw" value="<?php echo $agent_rate['drawing']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="tlight" type="text" id="tlight" value="<?php echo $agent_rate['tlight']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="aphotos" type="text" id="aphotos" value="<?php echo $agent_rate['aphotos']; ?>" size="12" /></div>
							<div class="clear"></div>
							...
							<div class="clear"></div>
							<div class="section_form_20">Rate:&nbsp;<input name="avid" type="text" id="avid" value="<?php echo $agent_rate['avid']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="zd" type="text" id="zd" value="<?php echo $agent_rate['3d']; ?>" size="12" /></div>
							<div class="section_form_20">Rate:&nbsp;<input name="atc" type="text" id="atc" value="<?php echo $agent_rate['atc']; ?>" size="12" /></div>
							<div class="clear"></div>
						</div>
						<div class="section_footer">
							<div class="section_navigate">
								<input name="agent" type="hidden" value="<?php echo $a_id; ?>" /><input name="level" type="hidden" value="agent" />
							</div>
							<div class="section_submit">
								<input class="section_submit_button_md" name="Submitagent" type="submit" id="Submitagent" value="Submit" />
							</div>
							<div class ="clear"></div>
						</div>
					</div>
