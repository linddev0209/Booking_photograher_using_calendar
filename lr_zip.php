...
while($photo_gal = mysqli_fetch_array($photo_db)){
	if (file_exists('./floorplan/'.$order_id.'/photos/'.$order_id."_".$photo_gal['fp_id']."_".$photo_gal['id'].'_lr.jpg')) {
	$zip->FileAdd('photos/'.$order_id."_".$photo_gal['fp_id']."_".$photo_gal['id'].'.jpg', './floorplan/'.$order_id.'/photos/'.$order_id."_".$photo_gal['fp_id']."_".$photo_gal['id'].'_lr.jpg', TBSZIP_FILE);
} else {
	$image = new SimpleImage();
    $image->load('./floorplan/'.$order_id.'/photos/'.$order_id."_".$photo_gal['fp_id']."_".$photo_gal['id'].'.jpg');
    $image->resizeToHeight(480);
    $image->save('./floorplan/'.$order_id.'/photos/'.$order_id."_".$photo_gal['fp_id']."_".$photo_gal['id'].'_lr.jpg'); }
	$zip->FileAdd('photos/'.$order_id."_".$photo_gal['fp_id']."_".$photo_gal['id'].'.jpg', './floorplan/'.$order_id.'/photos/'.$order_id."_".$photo_gal['fp_id']."_".$photo_gal['id'].'_lr.jpg', TBSZIP_FILE);
...
while($photo_gal = mysqli_fetch_array($photo_db)){
	unlink('./floorplan/'.$order_id.'/photos/'.$order_id."_".$photo_gal['fp_id']."_".$photo_gal['id'].'_lr.jpg');	
}
