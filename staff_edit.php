...
if ($s_id!="") {
	if(!($staff_db = mysqli_query($link,"select * from users where id = '$s_id'"))){
		printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
		exit();
	}
	$data_staff = mysqli_fetch_array($staff_db);
}

if($_POST['SubmitStaff']){
	$s_id = $_POST['staff'];
	if($s_id!="") {
		if(!($staff_db = mysqli_query($link,"select * from users where id = '$s_id'"))){
		printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
	...
	if($s_id!="") {
		if(!($staff_update = mysqli_query($link,"UPDATE users SET email='$email',pass='$passencrypt',firstname='$firstname',lastname='$lastname',site='$site',address='$address',city='$city',state='$state',zip='$zip',office_phone='$officephone',cell_phone='$cellphone',level='$level',active='$active' WHERE id = '$s_id'"))){
			printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
			exit();
		}
	} else {
		if(!($staff_update = mysqli_query($link,"INSERT INTO users SET email='$email',pass='$passencrypt',firstname='$firstname',lastname='$lastname',site='$site',address='$address',city='$city',state='$state',zip='$zip',office_phone='$officephone',cell_phone='$cellphone',level='$level',active='$active'"))){
			printf("%s", sprintf("internal error %d:%s\n", mysqli_errno($link), mysqli_error($link)));
			exit();
		}	
	}
	...
	if($_FILES['uphoto']['name'] != NULL){ 
		$file_name = $_FILES['uphoto']['name'];
      	...
      	if(in_array($file_ext,$expensions)=== false){
          	header("Location: staff_edit.php?staff=".$photo_id."&flag=notvalid");
		  	exit;
      	}
	...
	header("Location: staff_edit.php?staff=".$photo_id."&flag=".$flag."");
	exit();	
...
<html>
	<head>
		...
		<title>Manage Staff | Look2 Home Marketing</title>
					...
					<div class="section_container">
						...
						<div class="section_result_row">
							...
							<div class="section_form_36">
								<input name="fname" type="text" id="fname" value="<?php echo $data_staff['firstname']; ?>" size="32" />
							</div>
							<div class="section_form_14">
								Address:
							</div>
							<div class="section_form_36">
								<input name="address" type="text" id="address" value="<?php echo $data_staff['address']; ?>" size="32" />
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
								Last Name:
							...
							<div class="section_form_36">
								<input name="lname" type="text" id="lname" value="<?php echo $data_staff['lastname']; ?>" size="32" />
							</div>
							<div class="section_form_14">
								City:
							</div>
							<div class="section_form_36">
								<input name="city" type="text" id="city" value="<?php echo $data_staff['city']; ?>" size="32" />
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
								&nbsp;
							...
							<div class="section_form_14">
								<input name="state" type="text" id="state" value="<?php echo $data_staff['state']; ?>" size="4" maxlength="2" />
							</div>
							<div class="section_form_10">
								Zip:
							</div>
							<div class="section_form_14">
								<input name="zip" type="text" id="zip" value="<?php echo $data_staff['zip']; ?>" size="10" maxlength="5" />
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
								Email Address:
							...
							<div class="section_form_36">
								<input name="email" type="text" id="email" value="<?php echo $data_staff['email']; ?>" size="32" />
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
								Cell Phone:
							...
							<div class="section_form_36">
								<input name="cell" type="text" id="cell" value="<?php echo $data_staff['cell_phone']; ?>" size="24" maxlength="12" /><br>ex. 555-555-5555
							</div>
							<div class="section_form_14">
								Office Phone:
							</div>
							<div class="section_form_36">
								<input name="officephone" type="text" id="officephone" value="<?php echo $data_staff['office_phone']; ?>" size="24" maxlength="12" /><br>ex. 555-555-5555
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
								Dealer Photo:
							...
							<div class="section_form_36">
								<span class="agent_pic_order_80">
									<?php if(file_exists("floorplan/profile/".$s_id.".jpg")){ ?><img src="floorplan/profile/<?php echo $s_id; ?>.jpg" width="80px" alt="<?php echo $data_staff['firstname']." ". $data_staff['lastname']; ?>"><?php } ?>
								</span>
							</div>
							<div class="clear"></div>
							<div class="section_form_14">
							...
							<div class="section_form_36">
								<select name="active" id="active">
                    				...
                    				<option value="n" <?php if($data_staff['active']=='n') echo "selected" ?>>No</option>
                  				</select>
							</div>
							<div class="clear"></div>
						</div>
						<div class="section_footer">
							<div class="section_navigate">
								<input name="staff" type="hidden" value="<?php echo $s_id; ?>" /><input name="level" type="hidden" value="staff" />
							</div>
							<div class="section_submit">
								<input class="section_submit_button_md" name="SubmitStaff" type="submit" id="SubmitStaff" value="Submit" />
							</div>
							<div class ="clear"></div>
						</div>
					</div>
